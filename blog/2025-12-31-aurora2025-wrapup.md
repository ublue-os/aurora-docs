...
So this year we refactored the repository, since it was created before `bootc` and we were falling behind. As said, we want to share as much of the general code with [Bluefin](https://projectbluefin.io) and also with [Bazzite](https://bazzite.gg). We share many things and we wanted a cleaner way to do this. So the new architecture looks like this:
