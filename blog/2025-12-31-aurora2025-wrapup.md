...
As we have mentioned, we are currently refactoring how our images are made. We have been working with [Bluefin folks](https://projectbluefin.io) to streamline our builds. At some point we noticed that we are mostly 1:1 in features, so why spend time deduplicating every feature to both repos.
...
In 2026 we will be also looking into incorporating `aurora-dx` things without the need for a separate image and give you more flexibility moving forward:
...
So this is still in a **very early planning phase** and doesn't require any user action at the moment. We'll keep you updated as we make progress on this front.
