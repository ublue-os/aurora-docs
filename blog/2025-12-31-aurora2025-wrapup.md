...
Aurora metrics can be found from [LFX Insights](https://insights.linuxfoundation.org/) which we started using this year. Here is our [contributor metrics](https://insights.linuxfoundation.org/project/aurora/contributors).
